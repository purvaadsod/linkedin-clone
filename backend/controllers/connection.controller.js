...
export const acceptConnection = async (req, res) => {
  try {
    ...
    if (!connection) {
      return res.status(400).json({ message: "connection does not exsist!" });
    }
...
export const getConnectionStatus = async (req, res) => {
  try {
    ...
    return res.json({ statusbar: "connect" });
  } catch (error) {
...
export const removeConnection = async (req, res) => {
  try {
    ...
    const otherUserId = req.params.usrId;
...
export const getUserConnections = async (req, res) => {
  try {
    ...
    console.log(error);
    return res.status(500).json({ message: "get user connections error" });
  }
};
