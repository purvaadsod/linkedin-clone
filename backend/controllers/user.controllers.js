...
export const updateProfile = async (req,res)=>{
     try {
      let {firstName,lastName,userNae,headline,location,gender} = req.body
      ...
      let user = await User.findByIdAndUpdate(req.userId,{
        firstName,lastName,userNae,headline,location,gender,skills,experience,profileImage,coverImage
...
export const search = async (req,res) => {
  try {
     ...
     let users = await User.find({
      $or:[
        {firstName:{$regex:query,$options:"i"}},  //$option:"i" --> case insesnsitive
